...
Look at [bpe.py](/tinylm/bpe.py) for an minimal implementaion of the Byte-Pair Encoding tokenizer by [tiktoken](https://github.com/openai/tiktoken/blob/main/tiktoken/_educational.py).
